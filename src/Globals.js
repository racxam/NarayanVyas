...
class Globals {
    ...
    static initialize() {
        ...
        Globals.homePageHeaderDescription = `Narayan Vyas, an academician at ${Globals.currentOrganization}, specializes in computer science, focusing on IoT and Mobile App Development. He has trained over 1000 students globally and published extensively in Scopus journals. An active IEEE member, his research interests include Remote Sensing, Machine Learning, and Computer Vision.`;
        Globals.sidebarDescription = `I'm Narayan Vyas, Founder & CEO of Web Dev Fusion, with over ${Globals.totalExperience} years of experience in Web Design, UI/UX, and Mobile App Development. I've completed ${Globals.projectsCount}+ projects, delivering high-quality solutions. Get in touch to discuss how I can help your business thrive!`;
    }
}
