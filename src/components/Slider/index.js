...
function index() {
  return (
    <div className="container1">
      <h1 className="heading1">Flower Gallery</h1>
      <Swiper
        effect={'coverflow'}
        grabCursor={true}
        centeredSlides={true}
      ...
      >
        ...
        <div className="slider-controler">
          <div className="swiper-button-prev slider-arrow1">
            <ion-icon name="arrow-back-outline1"></ion-icon>
          </div>
          <div className="swiper-button-next slider-arrow">
            <ion-icon name="arrow-forward-outline1"></ion-icon>
          </div>
