...
const servicesData = [
    {
        ...
        whatYouGet: [
            ...
            "Dedicated Support",
            "Optimized & Well Tested Code",
            "Your Business Goals"
        ],
        descriptionParagraphs: [
            {
                title: "",
                content: "In today’s digital age, having a mobile application is crucial for any business aiming to enhance its reach and customer engagement. As an expert in Flutter with extensive experience working with international clients, I specialize in providing top-notch mobile application development services for both Android and iOS platforms. With a commitment to excellence, I transform your innovative ideas into high-performing mobile applications."
            },
            {
    ...
    },
    {
        ...
        descriptionParagraphs: [
            {
                title: "",
                content: "Publishing your research in reputed journals is a critical step in establishing your academic and professional credibility. As an experienced researcher, I offer comprehensive publication assistance services to help you successfully publish your work in Scopus and SCI-indexed journals. With a commitment to excellence, I provide expert guidance, thorough review, and dedicated support throughout the publication process."
            },
            {
    ...
    },
    {
        ...
        descriptionParagraphs: [
            {
                title: "",
                content: "As an experienced trainer, I offer comprehensive training and workshops both online and offline, specializing in IoT, Mobile App Development, Research, and Academic Writing. My training programs are designed to provide participants with the knowledge and skills they need to excel in their respective fields. With a commitment to excellence, I deliver high-quality instruction that is both practical and engaging."
            },
            {
